...
public class StringAlign extends Format {
    ...
    private final Alignment aligment;//当前对齐
    private final int maxPages;//当前最大长度
    ...
    public static void main(String[] args) {
        ...
        StringAlign align = new StringAlign(50, StringAlign.Alignment.CENTER);//调用构造方法，设置字符串对齐为居中对齐，最大长度为50
    ...
    @Override
    public StringBuffer format(Object input, @NotNull StringBuffer where, @NotNull FieldPosition ignore) {
        // TODO Auto-generated method stub
    ...
    @Override
    public Object parseObject(String source, @NotNull ParsePosition pos) {//用处不大
        // TODO Auto-generated method stub
        return source;
    }

...
@Slf4j
@Getter
public final class ChatGPTConfig extends ApplicationConfig {
    /**
     * 完成时生成的最大回答字数。
...
//    private String suffix = "";
     ...
     */
    @Setter
    private String prompt = "Please repeat this sentence. You did not specify any question content";
    /**
     * 为每个提示生成多少完成。
...
//    private String logit_bias = "";
    ...
    public ChatGPTConfig(boolean isInit) {
        super(isInit);
    ...
    public void setEcho(boolean echo) {
        this.echo = echo;
        this.put("echo", String.valueOf(echo));
    }
    ...
    @Override
    public ChatGPTConfig clone() {
        return (ChatGPTConfig) super.clone();
    }
}

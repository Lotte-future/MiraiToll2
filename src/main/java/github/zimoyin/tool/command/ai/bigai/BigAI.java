package github.zimoyin.tool.command.ai.bigai;
...
import github.zimoyin.mtool.uilt.IO;
...
@CommandClass
public class BigAI {
    private String applicationPath = "./lib/bigPictureAI/realesrgan-ncnn-vulkan.exe";
    private String modelName = "realesrgan-x4plus-anime";

package github.zimoyin.tool.command;
...
import github.zimoyin.tool.command.pojo.music.qq.Music;
import github.zimoyin.tool.command.pojo.music.qq.QQMusicJson;
...
public class CommandMusic {
    ...
    private static Logger logger = LoggerFactory.getLogger(CommandMusic.class);
